...
__decorate([
    (0, typeorm_1.ManyToOne)(() => order_entity_2.Product, (product) => product.orderItems, { onDelete: 'CASCADE' }),
    __metadata("design:type", typeof (_b = typeof order_entity_2.Product !== "undefined" && order_entity_2.Product) === "function" ? _b : Object)
